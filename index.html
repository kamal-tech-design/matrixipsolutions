...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>Matrix Ip Solutions</title>
  ...
  <body>
      ...
      <div class="row gx-0">
        <div class="col-lg-8 text-center text-lg-start mb-2 mb-lg-0">
          <div class="d-inline-flex align-items-center" style="height: 45px">
            <small class="me-3 text-light"
              ><i class="fa fa-map-marker-alt me-2"></i>505 Ansal Shivam
              RDC</small
            >
            <small class="me-3 text-light"
              ><i class="fa fa-phone-alt me-2"></i>+91-9027877567</small
            >
            <small class="text-light"
              ><i class="fa fa-envelope-open me-2"></i
              >info@matrixipsolutions.com</small
            >
          </div>
        </div>
        <div class="col-lg-4 text-center text-lg-end">
          <div class="d-inline-flex align-items-center" style="height: 45px">
            ...
            ></a>
            <a
              class="btn btn-sm btn-outline-light btn-sm-square rounded-circle me-0"
              href=""
    ...
    <div class="container-fluid position-relative p-0">
      <nav
        class="navbar navbar-expand-lg navbar-dark px-5 py-3 py-lg-0 bg-white"
      >
        <a href="index.html" class="navbar-brand p-0">
          <img
            src="./img/metrix-ip-solutuions-logo.png"
            alt="metrix ip solutuions logo"
            width="200"
            height="67"
          />
        </a>
          ...
          <div class="navbar-nav ms-auto py-0">
            ...
            <div class="nav-item dropdown">
              ...
              <div class="dropdown-menu m-0">
                <a href="search-engine-optimization.html" class="dropdown-item"
                  >Search Engine Optimization</a
                >
                <a href="website-designing.html" class="dropdown-item"
                  >Website Designing</a
                >
                <a href="website-development.html" class="dropdown-item"
                  >Website Development
                </a>
                <a
                  href="website-ecommerce-development.html"
                  class="dropdown-item"
        ...
        <div class="row gx-0">
          <div class="col-lg-4 wow zoomIn" data-wow-delay="0.1s">
            ...
            >
              ...
              <div class="ps-4">
                ...
                <h1 class="text-white mb-0" data-toggle="counter-up">618</h1>
              </div>
            </div>
          </div>
          <div class="col-lg-4 wow zoomIn" data-wow-delay="0.3s">
            ...
            >
              ...
              <div class="ps-4">
                ...
                <h1 class="mb-0" data-toggle="counter-up">642</h1>
              </div>
            </div>
          </div>
          <div class="col-lg-4 wow zoomIn" data-wow-delay="0.6s">
            ...
            >
              ...
              <div class="ps-4">
                <h5 class="text-white mb-0">Global Presence</h5>
          ...
          <div class="col-lg-7">
            ...
            >
              ...
              <div class="ps-4">
                ...
                <h4 class="text-primary mb-0">+91-9027877567</h4>
              </div>
            </div>
            <a
              href="quote.html"
        ...
        <div class="row g-5">
          ...
          <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.9s">
            ...
            >
              ...
              <h2 class="text-white mb-0">+91-9027877567</h2>
            </div>
          </div>
        </div>
      </div>
                ...
                <div class="row g-3">
                  ...
                  <div class="col-12">
                    ...
                    >
                      ...
                      <option value="Website Ecommerce Development">
      ...
      <div class="container">
        <div class="row gx-5">
          <div class="col-lg-5 col-md-6 footer-about">
            <div
              class="d-flex flex-column align-items-center justify-content-center text-center h-100 bg-primary p-4 bg-secondary"
            >
              <a href="index.html" class="navbar-brand">
                <h3 class="m-0 text-white">
                  <i class="fa fa-user-tie me-2"></i>MatrixIpSolutions
                </h3>
              </a>
              <p class="mt-3 mb-4">
            ...
            <div class="row">
              <div class="col-lg-6 col-md-12 pt-5 mb-5">
                ...
                <div class="d-flex mb-2">
                  ...
                  <p class="mb-0">
                    Office No. - 505 Ansal Shivam RDC Ghaziabad (UP)
                  </p>
                </div>
                <div class="d-flex mb-2">
                  <i class="bi bi-envelope-open text-primary me-2"></i>
                  <p class="mb-0">info@matrixipsolutions.com</p>
                </div>
                <div class="d-flex mb-2">
                  <i class="bi bi-telephone text-primary me-2"></i>
                  <p class="mb-0">+91-9027877567</p>
                </div>
